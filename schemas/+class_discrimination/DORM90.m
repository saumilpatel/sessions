%{
class_discrimination.DORM90 (computed) # Regress orientation over 90 degree range
...
classdef DORM90 < dj.Relvar & dj.AutoPopulate
    properties(Constant)
        table = dj.Table('class_discrimination.DORM90');

...
classdef MultiDimInfo < dj.Relvar & dj.AutoPopulate
    properties(Constant)
        ...
        popRel = pro(stimulation.StimTrialGroup & acq.Stimulation('exp_type="MultDimExperiment" OR exp_type="MouseMultiDim"'), stimulation.StimTrials, 'count(1) -> num_trials') & 'num_trials >= 6';
    end

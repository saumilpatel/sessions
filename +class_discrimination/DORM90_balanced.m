%{
class_discrimination.DORM90_balanced (computed) # Regress orientation over 90 degree range
...
classdef DORM90_balanced < dj.Relvar & dj.AutoPopulate
    properties(Constant)
        table = dj.Table('class_discrimination.DORM90_balanced');
